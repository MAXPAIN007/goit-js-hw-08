...
galleryElem.addEventListener('click', handleClickOnImg);
...
function handleClickOnImg(event) {
  ...
  const instance = basicLightbox.create(
    `
    <div class="modal">
        <img src="${originalImg}" width="1440" height="696">
        <a class="js-btn-close">X</a>
    </div>
  `,
    {
      onShow: instance => {
        const closeBtn = instance.element().querySelector('.js-btn-close');
